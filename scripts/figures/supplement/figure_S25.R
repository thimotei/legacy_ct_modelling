...
saveRDS(dt_samples, "outputs/plot_data/supplement/figure_S25_samples.rds")
saveRDS(dt_params_true_long, "outputs/plot_data/supplement/figure_S25_true_params.rds")

# Saving the plots
ggsave("outputs/figures/pdfs/supplement/figure_S25.pdf", 
       p_sim,
       width = 8,
       height = 5,
       bg = "white")

ggsave("outputs/figures/pngs/supplement/figure_S25.png", 
       p_sim,
       width = 8,
       height = 5,
       bg = "white")
