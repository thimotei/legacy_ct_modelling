...
#   individual_variation = 0.2, # control the amount of individual-level variation
...
# fit_high_ind_var$save_object("outputs/fits/fit_high_ind_var.rds")
